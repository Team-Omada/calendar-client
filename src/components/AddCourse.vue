...
export default {
  ...
  data() {
    return {
      ...
      timeError: "",
      days: [
        { label: "Mon", value: { name: "monday", assoc: 2 } },
        { label: "Tue", value: { name: "tuesday", assoc: 3 } },
        { label: "Wed", value: { name: "wednesday", assoc: 4 } },
        { label: "Thu", value: { name: "thursday", assoc: 5 } },
        { label: "Fri", value: { name: "friday", assoc: 6 } },
        { label: "Sat", value: { name: "saturday", assoc: 1 } },
        { label: "Sun", value: { name: "sunday", assoc: 7 } },
      ],
      course: {
        courseID: null,
        courseName: null,
